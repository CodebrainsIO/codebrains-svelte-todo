...
var app = (function () {
    ...
    // (26:8) <Button type="submit" on:click={submit} disabled={disabled}>
    function create_default_slot_3$1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(26:8) <Button type=\\\"submit\\\" on:click={submit} disabled={disabled}>",
    		ctx
    	});
    ...
    function create_default_slot$1(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*$$scope, disabled, title*/ 19) {
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console_1$1.warn(`<TodoForm> was created with unknown prop '${key}'`);
    	});
    	...
    	return [title, disabled, submit, textinput_value_binding];
    }
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*cell*/ 8 && t_value !== (t_value = /*cell*/ ctx[3].value + "")) set_data_dev(t, t_value);
    		},
    		i: noop,
    		o: noop,
    		d: function destroy(detaching) {
    ...
    function create_if_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(9:4) {#if cell.key === \\\"completed\\\"}",
    		ctx
    	});
    ...
    function create_default_slot_3(ctx) {
    	...
    	function toggle_handler(...args) {
    		return /*toggle_handler*/ ctx[1](/*row*/ ctx[4], ...args);
    	}

    	toggle = new Toggle$1({
    			props: { toggled: /*cell*/ ctx[3].value },
    			$$inline: true
    		});
    	...
    	const block = {
    		...
    		p: function update(new_ctx, dirty) {
    			...
    			if (dirty & /*cell*/ 8) toggle_changes.toggled = /*cell*/ ctx[3].value;
    ...
    // (12:14) <Button kind="danger" on:click={(e) => console.log(row)}>
    function create_default_slot_2(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(12:14) <Button kind=\\\"danger\\\" on:click={(e) => console.log(row)}>",
    		ctx
    	});
    ...
    function create_default_slot_1(ctx) {
    	...
    	function click_handler(...args) {
    		return /*click_handler*/ ctx[2](/*row*/ ctx[4], ...args);
    	}
    ...
    function create_cell_slot(ctx) {
    	...
    	function select_block_type(ctx, dirty) {
    		if (/*cell*/ ctx[3].key === "completed") return 0;
    		return 1;
    	}
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(span, file$1, 7, 2, 263);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, span, anchor);
    	...
    	datatable = new DataTable$1({
    			props: {
    				...
    				$$slots: {
    					cell: [
    						create_cell_slot,
    						({ cell, row }) => ({ 3: cell, 4: row }),
    						({ cell, row }) => (cell ? 8 : 0) | (row ? 16 : 0)
    					]
    				},
    				$$scope: { ctx }
    			},
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	const toggle_handler = (row, e) => console.log(row);
    	const click_handler = (row, e) => console.log(row);
    	...
    	return [todos, toggle_handler, click_handler];
    }
    ...
    class TodoList extends SvelteComponentDev {
    	constructor(options) {
    		...
    		if (/*todos*/ ctx[0] === undefined && !('todos' in props)) {
    			console_1.warn("<TodoList> was created without expected prop 'todos'");
    		}
    	}
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h2, file, 33, 2, 1592);
    			attr_dev(main, "class", "svelte-177t831");
    			add_location(main, file, 32, 0, 1583);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
